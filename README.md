...
This site is generated from markdown files in the project root.

## How it works

- `scripts/build-content.mjs` scans all `*.md` files in this folder.
...
1. Drop new `.md` files (and images) into this folder.
2. Run `npm run build`.
